...
namespace Carom {
    class Glb {
        // 원과 선분의 교점
        public static Vector2? FindLineCircleIntersection(Vector2 p1, Vector2 p2, Vector2 cp, float cr) {
            float a, b, c, det;
        ...
        // 선분과 선분의 교점
        public static Vector2? FindLineLineIntersection(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4) {
